...
<body class="fndimg">
	...
	<table>
		<tr>
			...
			<td>Codigo</td>
			<td> <input type='number' name='codigo' value='<?php echo $linea->getCodigo()?>' class="form-control" required></td>
		</tr>
		<tr>
			<td>Descripcion:</td>
			<td><input type='text' name='descripcion' value='<?php echo $linea->getDescripcion()?>' class="form-control" required></td>
		</tr>
		<input type='hidden' name='actualizar_sub' value='actualizar'>
	</table>
